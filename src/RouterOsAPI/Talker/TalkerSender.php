...
namespace RouterOsAPI\Talker;

use RouterOsAPI\Core\Connector,
    RouterOsAPI\Util\SentenceUtil,
    RouterOsAPI\Entity\Attribute,
    RouterOsAPI\Util\Util,
    RouterOsAPI\Util\DebugDumper;
