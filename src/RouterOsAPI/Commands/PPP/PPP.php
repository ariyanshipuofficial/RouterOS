...
namespace RouterOsAPI\Commands\PPP;

use RouterOsAPI\Talker\Talker;
use RouterOsAPI\Commands\PPP\Active,
    RouterOsAPI\Commands\PPP\Secret,
    RouterOsAPI\Commands\PPP\AAA,
    RouterOsAPI\Commands\PPP\Profile;
